...
public class Course extends Object {
    ...
    public Course(Course toBeCopied) {
        ...
        this.startWeek = toBeCopied.startWeek;
        this.endWeek = toBeCopied.endWeek;
    }

    public boolean overlappingWeeks(Course option) {
        boolean res = false;
    ...
    public Course(String input) {
        ...
        if (info.length > 0) {
            ...
            this.startWeek = Integer.parseInt(info[9]);
            this.endWeek = Integer.parseInt(info[10]);
        }
    ...
    public boolean conflicts(Course option) {
        ...
        if (this.overlappingWeeks(option)) {
